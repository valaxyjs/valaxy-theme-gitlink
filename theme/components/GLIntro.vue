  ...
  <div class="gl-intro flex items-center" justify="center" w="full" h="screen">
    ...
    >
      <div class="avatar" flex="~ col" justify="center" items="center" m="t-2">
        ...
        <small v-if="config.author.name" op="70">
          {{ config.author.name }}
        </small>
      </div>
      <h1 font="black" text="2xl" m="t-4">
        {{ config.title }}
      </h1>
      <h2 op="75" m="y-2">
        {{ config.subtitle }}
      ...
      <blockquote
        v-if="config.author.intro"
        m="y-4" p="y-2" op="80" text="sm center"
        class="border-y border-b-gray-200 border-t-gray-200"
      >
        {{ config.author.intro }}
      </blockquote>
